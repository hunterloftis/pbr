...
func main() {
	...
	scene.Add(
		...
		pbr.UnitCube(pbr.Ident().Trans(0.175, 0.05, 0.175).Rot(pbr.Vector3{0, 0.55 * math.Pi, 0}).Scale(0.01, 0.2, 0.1), greenGlass),
		pbr.UnitCube(pbr.Ident().Trans(0, -0.55, 0).Scale(1000, 1, 1000), (&pbr.Material{}).Init()),
